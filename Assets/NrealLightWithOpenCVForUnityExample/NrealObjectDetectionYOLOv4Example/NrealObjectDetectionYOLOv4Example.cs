...
namespace NrealLightWithOpenCVForUnityExample
{
    ...
    {
        public Text DEBUGwebCamTextureToMatHelperIsPlaying;
        ...
        {
            DEBUGwebCamTextureToMatHelperIsPlaying.text = webCamTextureToMatHelper.IsPlaying()? "eToMatHelperIsPlaying True": "eToMatHelperIsPlaying False";
            DEBUGwebCamTextureToMatHelperDidUpdateThisFrame.text = webCamTextureToMatHelper.DidUpdateThisFrame()? "DidUpdateThisFrame() True": "DidUpdateThisFrame False";
            DEBUGimageOptimizationHelperIsCurrentFrameSkipped.text = imageOptimizationHelper.IsCurrentFrameSkipped()? "IsCurrentFrameSkipped True": "IsCurrentFrameSkipped False";
            DEBUGCameraName.text = webCamTextureToMatHelper.requestedDeviceName;
