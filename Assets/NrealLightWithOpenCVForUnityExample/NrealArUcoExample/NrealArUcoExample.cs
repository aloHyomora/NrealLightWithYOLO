...
namespace NrealLightWithOpenCVForUnityExample
{
    ...
    public class NrealArUcoExample : MonoBehaviour
    {
        ...
        public void OnWebCamTextureToMatHelperInitialized()
        {
            ...
            distCoeffs = new MatOfDouble(new double[] { distort.distortParams[0],distort.distortParams[1],distort.distortParams[2],distort.distortParams[3],distort.distortParams[4] });

            Debug.Log("Created CameraParameters from NRFrame.GetDeviceIntrinsicMatrix on device.");

#else
            
            //NRFrame.EyePoseFromHead
